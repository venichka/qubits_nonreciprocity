...
%DIF ADD main_revised.tex   Thu Jan 11 10:42:34 2024
...
\begin{IEEEkeywords}
\DIFdelbegin \DIFdel{Superconducting qubits, nonreciprocity}\DIFdelend \DIFaddbegin \DIFadd{Nonreciprocity, quantum correlations}\DIFaddend , subradiance, \DIFdelbegin \DIFdel{quantum correlations
}\DIFdelend \DIFaddbegin \DIFadd{superconducting qubits.
...
\end{align}
The first sum describes the individual qubits, as we showed in \DIFdelbegin \DIFdel{Eq. }\DIFdelend (\ref{eq:04}).
...
\DIFaddbegin \DIFadd{Subsequently, we employ a quantum description of the system of two qubits coupled to a waveguide with an effective Hamiltonian, and the system's evolution is characterized by the master equation in Lindblad form.
}
