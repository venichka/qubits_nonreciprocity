...
Subsequently, we employ a quantum description of the system od two qubits coupled to a waveguide with an effective Hamiltonian, and the system's evolution is characterized by the master equation in Lindblad form.
...
Fig.~\ref{fig:03}(a,b) also demonstrates how the increase in the number of levels in the qubits affects the nonreciprocity effect, namely, transmission and reflection.
...
The $g^{(2)}_L(\tau)$ functions, Eq.~(\ref{eq:21}), are shown in Fig.~\ref{fig:06}(b).
